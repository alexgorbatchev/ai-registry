...
- `docs/internal/architecture.md` at the project root for project-specific architecture, design decisions, and local constraints
...
You MUST load the `persistent-memory-files` skill before creating, editing, or compacting `{{repo_root}}/wiki/LEARNINGS.md` or any project `docs/internal/architecture.md` file.
