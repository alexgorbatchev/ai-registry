...
date_status: "last_updated"
source_date: "2026-01-12"
source_date_type: "footer_last_updated"
date_note: "The page did not expose a publish date, but its footer exposed an official last-updated date."
...
The code you already use for cases like [text generation](https://ai.google.dev/gemini-api/docs/text-generation) or [multimodal inputs](https://ai.google.dev/gemini-api/docs/vision) will work without any changes with long context.
...
For the context window sizes of specific models, see the [Models](https://ai.google.dev/gemini-api/docs/models) page.
