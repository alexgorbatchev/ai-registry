...
source_date: "2026-01-16T15:44:09Z"
source_date_type: "page_metadata_published_time"
date_note: "The page exposes a Published Time value in fetched metadata."
...
*   [Manage cookies](https://ai.google.dev/gemini-api/docs/system-instructions#)

*   [English](https://ai.google.dev/gemini-api/docs/system-instructions)
*   [Deutsch](https://ai.google.dev/gemini-api/docs/system-instructions)
*   [Español – América Latina](https://ai.google.dev/gemini-api/docs/system-instructions)
*   [Français](https://ai.google.dev/gemini-api/docs/system-instructions)
*   [Indonesia](https://ai.google.dev/gemini-api/docs/system-instructions)
*   [Italiano](https://ai.google.dev/gemini-api/docs/system-instructions)
*   [Polski](https://ai.google.dev/gemini-api/docs/system-instructions)
*   [Português – Brasil](https://ai.google.dev/gemini-api/docs/system-instructions)
*   [Shqip](https://ai.google.dev/gemini-api/docs/system-instructions)
*   [Tiếng Việt](https://ai.google.dev/gemini-api/docs/system-instructions)
*   [Türkçe](https://ai.google.dev/gemini-api/docs/system-instructions)
*   [Русский](https://ai.google.dev/gemini-api/docs/system-instructions)
*   [עברית](https://ai.google.dev/gemini-api/docs/system-instructions)
*   [العربيّة](https://ai.google.dev/gemini-api/docs/system-instructions)
*   [فارسی](https://ai.google.dev/gemini-api/docs/system-instructions)
*   [हिंदी](https://ai.google.dev/gemini-api/docs/system-instructions)
*   [বাংলা](https://ai.google.dev/gemini-api/docs/system-instructions)
*   [ภาษาไทย](https://ai.google.dev/gemini-api/docs/system-instructions)
*   [中文 – 简体](https://ai.google.dev/gemini-api/docs/system-instructions)
*   [中文 – 繁體](https://ai.google.dev/gemini-api/docs/system-instructions)
*   [日本語](https://ai.google.dev/gemini-api/docs/system-instructions)
*   [한국어](https://ai.google.dev/gemini-api/docs/system-instructions)
